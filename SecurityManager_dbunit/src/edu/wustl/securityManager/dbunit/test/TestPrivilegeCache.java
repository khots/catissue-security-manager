...
public class TestPrivilegeCache extends TestCase {
	...
	{
		boolean hasPrivilege = cache.hasPrivilege
		("edu.wustl.catissuecore.domain.Participant","READ");
	...
	public void testGetPrivilegesforPrefix()
	{
		...
		Map<String, List<NameValueBean>> privilegeMap = cache.getPrivilegesforPrefix("edu.wustl.catissuecore.domain.Address");
